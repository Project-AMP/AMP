...
<div class="Biggroup">
	<div class="Smallgroup">
		<div id="myinfo_sidebarDiv"></div>
			<script type="text/javascript">ajaxDo('myinfo_sidebar? &bgColorSet=myinfo_completeclasscheck','#myinfo_sidebarDiv');
		</script>

		<div id="myinfoMain_container">
		<div id="container">
		<div class="myinfo_completeclasscheck_h2"><h2>이전 수강 내역</h2></div>
		<div class="myinfo_completeclasscheck_div">
					<%
		int num=0;
