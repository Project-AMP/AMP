...
<body>
<script>
<%if(request.getParameter("bgColorSet")!=null&&request.getParameter("bgColorSet").equals("event")){ %>
    ...
    <div class="wrapper">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                	<li id="Colorset1"><a href="event">수학</a></li>
                	<li id="Colorset2"><a href="event">영어</a></li>
                	<li id="Colorset3"><a href="event">it</a></li>
            </ul>
        </nav>
    </div>
